...
public class Activity2 {
  ...
  public void getUserInfo() {
      ...
      response.then().body("username", equalTo("Swagatika"));
      response.then().body("firstName", equalTo("Swagatika"));
      response.then().body("lastName", equalTo("Biswal"));
  ...
  public void deleteUser() throws IOException {
      ...
      response.then().body("code", equalTo(200));
      response.then().body("message", equalTo("Swagatika"));
  }
